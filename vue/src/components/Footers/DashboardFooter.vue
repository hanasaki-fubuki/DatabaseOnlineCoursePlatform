		...
		<a-row type="flex">
			<a-col :span="24" :md="12">
				...
				<p class="copyright">
					...
					by <a href="https://hanasaki-blog.microdream.tech">Hanasaki Fubuki</a> for a better web.
				</p>
				<!-- / Footer Copyright Notice -->
			...
			<a-col :span="24" :md="12" class="footer-control">
				...
				<a-menu mode="horizontal">
					<a-menu-item>
            <a href="https://hanasaki-blog.microdream.tech/"/>
            Hanasaki Fubuki 的 Blog
          </a-menu-item>
					<a-menu-item>
            <a href="https://github.com/hanasaki-fubuki/"/>
            Hanasaki Fubuki 的 Github
          </a-menu-item>
					<a-menu-item>
